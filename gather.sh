...
mkdir -p bin ghc git gtk/gtk-3.0 i3 msmtp mutt offlineimap profile systemd vim xorg ipython/profile_default/startup/
...
cp -f ${HOME}/.ipython/profile_default/startup/00-math.py ipython/profile_default/startup/
